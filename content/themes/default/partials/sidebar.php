		...
		<div id="sidebar" <?php if(isset($single) && $single): ?>style="margin-top:27px;"<?php else: ?>style="margin-top:15px;"<?php endif; ?>>
			...
			<?php else: ?>
				...
				<div class="social_block">
					...
					<iframe src="//www.facebook.com/plugins/likebox.php?href=http%3A%2F%2Fwww.facebook.com%2F<?= $settings->facebook_page_id ?>&amp;width&amp;height=220&amp;colorscheme=light&amp;show_faces=true&amp;header=false&amp;stream=false&amp;show_border=false" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
				</div>
