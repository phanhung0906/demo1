...
class CategoriesController extends BaseController {
	...
	public function store()
	{
		...
		if ($validation->passes())
		{
			...
			return Redirect::to('admin#categories')->with(array('note' => Lang::get('lang.new_category_success'), 'note_type' => 'success'));;
		}
	...
	public function update($id)
	{
		...
		if ($validation->passes())
		{
			...
			return Redirect::to('admin#categories')->with(array('note' => Lang::get('lang.update_success'), 'note_type' => 'success'));;
		}
	...
	public function delete($id)
	{
		...
		return Redirect::to('admin#categories')->with(array('note' => Lang::get('lang.delete_success'), 'note_type' => 'success'));
	}
