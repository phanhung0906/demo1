...
<?php foreach($media as $item): ?>
	...
	<div class="social_container">
		 <ul class="socialcount socialcount-large" data-url="<?= $media_url ?>">
			...
			<li class="twitter"><a href="https://twitter.com/intent/tweet?url=<?= $media_url ?>&text=<?= $item->title ?>" data-url="<?= $media_url ?>" title="<?= Lang::get('lang.share_twitter') ?>"><span class="fa fa-twitter" data-url="<?= $media_url ?>"></span><span class="count"><?= Lang::get('lang.tweet') ?></span></a></li>
