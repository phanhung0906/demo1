...
class InstallController extends BaseController {
	...
	public function upgrade(){
		...
		$upgraded = $this->upgrade152();
		$upgraded = $this->upgrade153();
	...
	public function upgrade152(){
		...
		if (!Schema::hasTable('notifications'))
		{
			...
			Schema::create('notifications', function($table) {
				...
				$table->integer('is_read')->default(NULL);
				$table->string('url_comment')->default(NULL);
				$table->timestamps();
			});

			Schema::table('media', function($table)
			{
				$table->text('pic_url_multi')->nullable();
				$table->text('delete_img')->nullable();
			});
	...
	public function upgrade153(){

		$return_value = false;

		if( !Schema::hasColumn('media', 'delete_img')){
			Schema::table('media', function($table)
			{
				$table->text('delete_img')->nullable();
			});
		...
		if( !Schema::hasColumn('media', 'pic_url_multi')){
			Schema::table('media', function($table)
			{
				$table->text('pic_url_multi')->nullable();
			});
