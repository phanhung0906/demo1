    ...
    <div class="container">
      ...
      <div class="navbar-header">
        ...
        @if(Auth::guest())
            ...
            <li class="@if(Request::is('login')) active @endif"><a href="{{ URL::to('login') }}">{{ Lang::get('lang.sign_in') }}</a></li>
      ...
      @if(Auth::guest())
          ...
          <li class="@if(Request::is('login')) active @endif"><a href="{{ URL::to('login') }}" id="login-button-desktop">{{ Lang::get('lang.sign_in') }}</a><div class="nav-border-bottom"></div></li>
          @if($settings->user_registration)
