...
class UserController extends BaseController{
	...
	public function facebook(){
		...
		if($settings->user_registration){	
		    ...
		    if ( !empty( $code ) ) {
		        ...
		        $result = $facebook->api('/me?fields=first_name,last_name,email');

		        if(!isset($result['email'])){ $result['email'] = $result['id']."@facebook.com"; }
	...
	public function update($id)
	{
		...
		if(Auth::user()->id == $id){
			...
			return Redirect::to('user/' . Auth::user()->username)->with(array('note' => 'Tisk Tisk Tisk... Why are you trying to update another user.', 'note_type' => 'error') );
		}
