...
<?php 
	if(isset($settings->random_bar_enabled) && $settings->random_bar_enabled == 1):
		include('partials/random-bar.php');
	endif; 
?>

<div id="main_container" <?php if(isset($settings->random_bar_enabled) && $settings->random_bar_enabled == 1): ?>class="random_bar"<?php endif; ?>>
